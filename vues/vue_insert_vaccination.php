...
<form method="post" action="">
  <table border="0">
    ...
    <tr>
      <td>
        <input type="text" placeholder="Nombre de doses" name="nbdose"
        value="<?php if($laVaccination!=null){ echo $laVaccination['nbdose'];}  ?>">
      </td>
    </tr>
    <tr>
      <td>
        <input type="text" placeholder="Température corporelle" name="temperature"
        value="<?php if($laVaccination!=null){ echo $laVaccination['temperature'];}  ?>">
      </td>
    </tr>
    <tr>
      <td>
        <input type="text" placeholder="Nom du médecin" name="nommedecin"
        value="<?php if($laVaccination!=null){ echo $laVaccination['nommedecin'];}  ?>">
      </td>
    </tr>
    <tr>
      <td>
